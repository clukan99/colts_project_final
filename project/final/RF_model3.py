...
print(y_train_np)
################################
rf = RandomForestClassifier(n_estimators= 400, min_samples_split= 2, min_samples_leaf= 1, max_features= 'sqrt', max_depth= 110, bootstrap= False, random_state= 1234, verbose= 2, n_jobs= 32)
...
######################################
rf.fit(X_train_np, y_train_np.ravel())

y_pred = rf.predict(X_test_np)

test_UniqueID['predictions'] = y_pred

test_UniqueID.to_csv("../../final_data_to_submit/RF_model3.csv")
